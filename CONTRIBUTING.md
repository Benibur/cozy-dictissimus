# How to contribute to Cozy dictissimus?
...
- What is the version of the Cozy dictissimus app?
...
```
$ git clone github.com/benibur/cozy-dictissimus.git
$ cd cozy-dictissimus
$ git remote add fork git://github.com/yourusername/cozy-dictissimus.git
```
...
Go to https://github.com/yourusername/cozy-dictissimus and select your branch. Click the 'Pull Request' button and fill out the form.
...
The Cozy dictissimus is translated on a platform called [Transifex][tx]. [This tutorial][tx-start] can help you to learn how to make your first steps here. If you have any question, don't hesitate to ask us!
...
[issues]: https://github.com/benibur/cozy-dictissimus/issues/new
...
[localization]: https://github.com/benibur/cozy-dictissimus/blob/master/README.md#localization
